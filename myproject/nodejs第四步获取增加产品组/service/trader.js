 ...
 */
class Sale {
    constructor(traderID, url, banner) {
        this.createDt = new Date();
        this.lastModifyDt = new Date();
...
class TraderSevice {
    ...
    static isTraderExisit(username) {
        return __awaiter(this, void 0, void 0, function* () {
            var trader = yield TraderSevice.traderDb.findOne({ username });
...
TraderSevice.saleDb = config_1.Config.Db.collection('sales'); //拿到产品促销产品
